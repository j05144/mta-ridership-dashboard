...
|---|-----------------|-----|--------------------|-----------------------|-----------|
| 1 | Fresh open | Open the .pbix with nothing selected | All visuals load, KPI card shows the full 2020-2026 total across all modes | | |
...
| 10 | The COVID drop | Look at 2020 with no filters | The huge April 2020 collapse should be obvious in the line chart | | |
